 ...
 *  nodes).
 */
TVM_DLL Expr InlineTensors(const Expr& expr,
 ...
 *   efficiency.
 */
TVM_DLL SolveSystemOfInequalitiesResult SolveSystemOfInequalities(
    const Array<Expr>& inequalities,
 ...
 */
TVM_DLL DomainTransformation SimplifyDomain(const Domain& domain,
 ...
 */
TVM_DLL Expr ExtractAsTensorMaybe(const Expr& expr, const Expr& cond,
 ...
 */
TVM_DLL Expr ExtractReductions(const Expr& expr,
                               const Array<Var>& outer_axis,
                               const Map<Var, Range>& vranges);
 ...
 * \return An expression without non-top-level reductions.
 */
TVM_DLL Expr ExtractNonTopReductions(const Expr& expr,
                                     const Array<Var>& outer_axis,
                                     const Map<Var, Range>& vranges);
